...
auto HANode::getKey() const -> string { 
    return key; 
}

auto HANode::getData() const -> int { 
    return data; 
}

auto HANode::getIsDeleted() const -> bool { 
    return isDeleted; 
}

auto HANode::getIsEmpty() const -> bool { 
    return isEmpty; 
}
...
auto HashA::getTable() const -> HANode* { 
    return table; 
}

auto HashA::getCapacity() const -> int { 
    return capacity; 
}
